 ...
 *  вычислений.
 *  Они ещё называются группировкой, она имеет наивысшый приоритет.
 */

/**
 *  3) Оператор отрицания "не" работает таким образом, что он сначала превращает аргумент (к которому он прикреплён)
